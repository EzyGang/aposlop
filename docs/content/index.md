...
Aposlop reports Type-1, Type-2, and Type-3 duplicate matches without comparing every block pair.
...
- [Duplicate types](concepts/duplicate-types.md) explains Type-1, Type-2, and Type-3 duplicate matches.
